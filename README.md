...
![The enclosure: four parts to print.](docs/images/the-enclosure.png)

The V4 enclosure is designed around the HermitX development board: an all-in-one ESP32-S3 board that ships with the NFC antenna, a 3 W speaker and an NTAG215 card. It prints in four parts:
